...
class AppStore extends Component {
  ...
  getFilteredCategory = searchedApps => {
    const {activeTabId} = this.state
    const filteredCategory = searchedApps.filter(
  ...
  render() {
    ...
    const filteredCategory = this.getFilteredCategory(searchResults)
      ...
      <div className="app-container">
        <div className="destination-search-container">
          ...
          <ul className="project-list-container">
            {filteredCategory.map(appItemDetails => (
              <AppItem
